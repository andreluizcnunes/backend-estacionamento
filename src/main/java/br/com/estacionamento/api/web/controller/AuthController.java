...
import br.com.estacionamento.api.jwt.JwtToken;
import br.com.estacionamento.api.jwt.JwtUserDetailsService;
import br.com.estacionamento.api.web.dto.Auth.UserLoginDto;
...
public class AuthController {
    ...
    public ResponseEntity<?> auth(@RequestBody @Valid UserLoginDto dto, HttpServletRequest request) {
        ...
        try {
            ...
            JwtToken token = detailsService.getTokenAuthenticaticated(dto.getUsername());
